...
export const aboutHero = {
  ...
  stats: [
    ...
    { value: "€1M+", label: "Tracked client revenue" },
    { value: "Belgrade", label: "Home base" },
  ] as Metric[],
  ctas: [
...
export const aboutHow = {
  ...
  items: [
    ...
    },
    {
      ...
      body: "You get a number and a date before we start. From €2,500, most builds live in 2 to 5 weeks.",
    },
    {
...
export const aboutVouch = {
  heading: "Who vouches for us",
  intro: "Three of these you can verify without asking us.",
  items: [
    {
      name: "Wix",
      body: "Legend Partner, Wix's top partner tier, which puts us in roughly the top 1% of builders on the platform. The profile is public.",
      link: {
    ...
    {
      name: "Shopify",
      body: "Shopify Partner, for clients selling on Shopify alongside a Wix Studio marketing site.",
      link: null,
    },
    {
      name: "Trustpilot",
      body: "Client reviews are public and unedited. We link the profile rather than quote a score from it.",
      link: {
    ...
    },
    {
      ...
      link: { label: "White-label and partnerships", href: "/partnerships" },
    },
  ],
};
...
export const aboutFaq = {
  ...
  items: [
    ...
    },
    {
      ...
      a: "From €2,500 for a Wix Studio build, with landing pages from €1,250. Every project is quoted with a fixed price and a fixed timeline before work starts.",
    },
    {
