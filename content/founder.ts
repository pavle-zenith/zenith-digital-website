 ...
 *     row. Portrait left with floating `photoBadges` (rating badge, platform
 *     mark, stat chip); text right: heading, paragraph, `whyHeading` +
 *     `whyPoints` checklist with check icons.
 ...
 *
 * OWNER — two link URLs to supply (marked below): your Wix Partner profile
 * URL and the Clutch profile URL. The LinkedIn URL should be checked too.
 */
...
export const founderCore = {
  ...
  links: [
    // OWNER: confirm/supply the real URLs. Remove any that don't exist yet.
    { label: "LinkedIn", href: "https://www.linkedin.com/in/pavlemaodus" },
    { label: "Wix Partner profile", href: "[wix partner profile URL]" },
    { label: "Clutch", href: "[clutch profile URL]" },
    { label: "Email", href: "mailto:hello@thezenithdigital.com" },
  ] as FounderLink[],
  /**
   * Floating badges over the portrait (byCrawford expert-block pattern):
   * a review badge top-left, a platform mark lower-left, and a stat chip
   * over the photo's bottom-right corner.
   */
  photoBadges: {
    rating: { score: "5/5", platform: "Clutch" },
    platformLogo: { src: "/logos-white/wix-studio.png", alt: "Wix Studio" },
    stat: { value: "100+", label: "Websites built" },
  },
};
...
export const founderServices = {
  ...
  paragraphs: [
    ...
    "The rest of the proof is public: €1M+ in tracked client revenue, a 5/5 rating on Clutch, and the case studies on this site, with every number in them real.",
  ],
